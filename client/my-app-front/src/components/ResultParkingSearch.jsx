...
// Simulating Positions Before Fetching them from the DB
const position1 = { lat: 34.04, lng: -6.84 };
const position2 = { lat: 34.04, lng: -6.6 };

const ResultParkingSearch = () => {
  // Get the search data inputs from search page
...
export default ResultParkingSearch;
